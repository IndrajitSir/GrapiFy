export const initialNodes = [
 ...
 export const initialEdges = [
    { id: '1',source: '1', target: '2', animated: true, markerEnd: { type: 'arrow', color: 'red' }, style: { stroke: 'blue', strokeWidth: 2 } },
    { id: '2',source: '1', target: '3', animated: true, markerEnd: { type: 'arrow', color: 'red' }, style: { stroke: 'blue', strokeWidth: 2 } },
  ];
