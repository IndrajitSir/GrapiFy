...
export const initialEdges = [
  { id: 'e1-2', source: '1', target: '2', animated: true, style: { stroke: 'blue', strokeWidth: 2 }, weight: 5, label: '5'},
  { id: 'e1-3', source: '1', target: '3', animated: true, style: { stroke: 'blue', strokeWidth: 2 }, weight: 10, label: '10' },
];