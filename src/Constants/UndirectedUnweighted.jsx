...
export const initialEdges = [
  { id: 'e1-2', source: '1', target: '2', animated: true, markerEnd: { color: 'red' }, style: { stroke: 'blue', strokeWidth: 2 } },
  { id: 'e1-3', source: '1', target: '3', animated: true, markerEnd: { color: 'red' }, style: { stroke: 'blue', strokeWidth: 2 } },
];